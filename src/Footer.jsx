...
const Footer = () => {
  return (
    <motion.footer
      className="bg-gradient-to-l from-primary to-secondary text-white py-6 px-4 text-center"
    ...
    >
      ...
      >
        &copy; {new Date().getFullYear()} <span className="font-semibold">Login Signup Form</span> | All Rights Reserved
      </motion.div>
